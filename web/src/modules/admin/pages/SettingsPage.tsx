...
import { useCreateMotoboy, useDeleteMotoboy, useMotoboys } from '../hooks/useMotoboys'
import {
  useStore,
...
function TabMotoboys() {
  ...
  function handleCreate(e: React.FormEvent) {
    ...
    createMutation.mutate(
      ...
      },
      {
        ...
        onError: () => alert('Erro ao adicionar motoboy.'),
      }
    )
  }
  ...
  function handleDelete(id: string, motoboyName: string) {
    ...
    deleteMutation.mutate(id, {
      onError: () => alert('Erro ao remover motoboy.'),
    })
  }
