...
// `VITE_PUBLIC_ROOT_DOMAIN` é o domínio principal do produto (ex: `menupanda.ai`
...
const PRIMARY_ROOT = (import.meta.env.VITE_PUBLIC_ROOT_DOMAIN as string | undefined) || 'menupanda.ai'
